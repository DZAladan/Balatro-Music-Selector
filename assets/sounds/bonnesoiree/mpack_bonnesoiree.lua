...
local mpack_name = "bonnesoiree"

local mpack_display = "Bonne Soirée - Vongola"

SMODS.Sound({ 
    vol = 0.6,
    pitch = 1,
    key = "boso_music1",
    path = mpack_name .. "/boso_music1.ogg",
...
SMODS.Sound({
    ...
    pitch = 1,
    key = "boso_music2",
    path = mpack_name .. "/boso_music2.ogg",
    select_music_track = function()
...
SMODS.Sound({
    ...
    pitch = 1,
    key = "boso_music3",
    path = mpack_name .. "/boso_music3.ogg",
    select_music_track = function()
...
SMODS.Sound({
    ...
    pitch = 1,
    key = "boso_music4",
    path = mpack_name .. "/boso_music4.ogg",
    select_music_track = function()
...
SMODS.Sound({
    ...
    pitch = 1,
    key = "boso_music5",
    path = mpack_name .. "/boso_music5.ogg",
    select_music_track = function()
