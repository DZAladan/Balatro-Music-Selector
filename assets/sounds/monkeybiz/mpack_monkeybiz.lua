...
local mpack_name = "monkeybiz"

local mpack_display = "Monkey Business - Bombaflex"

SMODS.Sound({ 
    vol = 0.6,
    pitch = 1,
    key = "mobu_music1",
    path = mpack_name .. "/mobu_music1.ogg",
...
SMODS.Sound({
    ...
    pitch = 1,
    key = "mobu_music2",
    path = mpack_name .. "/mobu_music2.ogg",
    select_music_track = function()
...
SMODS.Sound({
    ...
    pitch = 1,
    key = "mobu_music3",
    path = mpack_name .. "/mobu_music3.ogg",
    select_music_track = function()
...
SMODS.Sound({
    ...
    pitch = 1,
    key = "mobu_music4",
    path = mpack_name .. "/mobu_music4.ogg",
    select_music_track = function()
...
SMODS.Sound({
    ...
    pitch = 1,
    key = "mobu_music5",
    path = mpack_name .. "/mobu_music5.ogg",
    select_music_track = function()
